...
Usage:
    spoofee list [--wifi]
    spoofee randomize [--local] <devices>...
    spoofee set <mac> <devices>...
    spoofee reset <devices>...
    spoofee normalize <mac>
    spoofee -h | --help
    spoofee --version
...
from spoofee.version import __version__
from spoofee.util import random_mac_address, MAC_ADDRESS_R, normalize_mac_address

from spoofee.interface import (
    wireless_port_names,
    find_interfaces,
    find_interface,
    set_interface_mac,
